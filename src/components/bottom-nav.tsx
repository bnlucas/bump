...
export function BottomNav() {
  ...
  return (
    <nav
      aria-label="Primary"
      className="sticky bottom-0 z-30 border-t border-[color:var(--border)] bg-[color:var(--background)]/90 backdrop-blur supports-[backdrop-filter]:bg-[color:var(--background)]/70"
